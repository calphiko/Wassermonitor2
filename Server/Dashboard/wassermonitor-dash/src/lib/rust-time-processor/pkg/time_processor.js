/* @ts-self-types="./time_processor.d.ts" */

/**
 * @param {any} raw
 * @returns {any}
 */
export function transform_time_data(raw) {
    const ret = wasm.transform_time_data(raw);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('time_processor_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
